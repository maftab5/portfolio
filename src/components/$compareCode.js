            ...
            <>
                ...
                {isFetching ? (
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 col-md-12 flex-row flex-center m-auto ">
                                <div className="col-lg-10 col-md-10 pr">
                                    <h3 className="projectsList">Projects</h3>
                                </div>
                                <div className="col-lg-2 col-md-2 col-sm-2 col-xs-2 SearchPrjs">
                        ...
                        {filteredProjs.map((item) => (
                            <div className="row mainPrj" style={{
                                marginBottom: '3%'
                            }}>
                                ...
                                <FadeInSection>
                                    ...
                                    <div className="row projectDivs">
                                        ...
                                        >
                                            <img src={item.image} className="img-responsive" height={400} width={350} />
                                        </div>
